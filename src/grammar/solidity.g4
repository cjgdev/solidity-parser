...
// | (_| (_) | | | | |_| | | (_| | (__| |_\__ \
//  \___\___/|_| |_|\__|_|  \__,_|\___|\__|___/
...
statevariabledeclaration
  : typename 'constant'? ( 'public' | 'internal' | 'private' )? Identifier ('=' expression)? ';'
  ;
...
arraytypename : Identifier storagelocation? '[' expression? ']' ;
...
assemblystatement : 'assembly' '{' assemblyexpression* '}' ;
...
expression
  ...
  | elementarytypename '(' lhs_expression ')'
  | lhs_expression
  | primaryexpression
  ;
...
//  _
// | |_ _   _ _ __   ___ _ __   __ _ _ __ ___   ___  ___
// | __| | | | '_ \ / _ \ '_ \ / _` | '_ ` _ \ / _ \/ __|
// | |_| |_| | |_) |  __/ | | | (_| | | | | | |  __/\__ \
//  \__|\__, | .__/ \___|_| |_|\__,_|_| |_| |_|\___||___/
//      |___/|_|
